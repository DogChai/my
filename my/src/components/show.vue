...
<div class="show">
  <div class="show-wrap">
    ...
    <div class="show-demo">
      ...
      <div class="demo-wrap">
        使用Canvas绘图API + JavaScript面向对象的编程方式所制作 使用序列帧动画控制+碰撞检测
      </div>
    </div>
    <div class="show-demo">
      <div class="demo-top">
      ...
      <div class="demo-wrap">
        使用Canvas绘图API制作 添加电脑AI，运用了赢法统计数组和胜负判断方法
      </div>
    </div>
    <div class="show-demo">
      <div class="demo-top">
      ...
      <div class="demo-wrap">
        使用table+dom操作， 随机生成色块， 控制方块前进， 或者自动前进
      </div>
    </div>
    <div class="show-demo">
      <div class="demo-top">
      ...
      <div class="demo-wrap">
        使用div+css布局， 操作dom添加或删除元素， 从而达到目的
      </div>
    </div>
    <div class="show-demo">
      <div class="demo-top">
...
.show-demo:hover .demos {
  opacity: 1;
}

.show-demo:hover .demo-top {
	/*color:white;*/
}
