...
// region[代码]
(function (symbol) {
    "use strict"file:///f%3A/my/lesses/lesses.js;
    // region[本库依赖变量]
    var version = "1.0.0";
    var contentTypes = [
    ...
    extend(window[symbol],{
        ...
        post:function (url,data,callback,contentType) {
            window[symbol].ajax({
                ...
                method:"post",
                callback:callback,
                reqType:contentType?contentType:contentTypes[1],
                resJSON:false,
                data:data
            });
        },
        postJSON:function (url,data,callback,contentType) {
            window[symbol].ajax({
                url:url,
                method:"post",
                callback:callback,
    ...
    window[symbol].removeSymbol = function (sym) {
        delete window[sym];
    };
